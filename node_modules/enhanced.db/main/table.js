...
class Table{
  ...
  constructor(tablename, options={}){
    ...
    if(options.clearOnStart && !cleared) this.base.all().map(db => db.key).forEach(key => this.base.delete(key)), cleared = true
  }
  ...
  is(key, value){
    if(!key || (!value && ![false, 0].includes(value))) throw new Error('Missing Key or value!')
